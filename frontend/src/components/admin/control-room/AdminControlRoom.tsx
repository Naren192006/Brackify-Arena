      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/10 pb-6">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="rounded-xl border border-cyan-400/40 bg-cyan-400/20 px-4 py-2 text-sm font-semibold text-arena-accent hover:bg-cyan-400/30 transition-colors shadow-lg shadow-cyan-950/40"
          >
            + Create Tournament
          </Link>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <input
              ...
              className="rounded-xl border border-white/10 bg-white/[0.04] px-3 py-1.5 text-xs text-white placeholder-arena-muted focus:border-cyan-400/50 focus:outline-none w-48 sm:w-64"
            />
