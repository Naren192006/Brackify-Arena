...
export function StatusBadge({
  ...
  switch (normalized) {
    ...
    default:
      return (
        <span className="inline-flex items-center gap-1.5 rounded-full border border-arena-accent bg-arena-bg-elevated px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wider text-arena-accent">
          Upcoming
        </span>
      );
  }
